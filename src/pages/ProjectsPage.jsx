        ...
        <div className="max-h-screen max-w-screen">
            ...
            <div className="flex-1 flex flex-wrap justify-center">
                {Projects.map((project) => (
                    <div key={project.title} onClick={() => projectClick(project.link)} className="text-gray-300 box m-2 bg-csprim flex flex-col flex-nowrap rounded-xl lg:w-1/4 overflow-scroll w-[300px] h-[200px]">
