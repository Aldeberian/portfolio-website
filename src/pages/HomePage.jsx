...
const HomePage = () => {
    return (
        <div className="flex-1 flex flex-col lg:flex-row lg:overflow-hidden overflow-y-auto ">
            <div className="w-full lg:w-1/2 lg:h-full flex-1 p-4 text-7xl font-titletxt">LOREM IPSUM IS SIMPLY DUMMY TEXT OF THE PRINTING AND TYPESETTING INDUSTRY. </div>
